...
All visitor-facing sentences from the landing screen were checked against the
plain-words rules. No sentence exceeds 22 words. No banned wording appears.
...
| Recipe details become a plain shopping card. | 7 | Pass |
...
| Add ingredient lines from any recipe app. | 7 | Pass |
